...
if to == 'user' or service or is_admin1(msg) and to == "chat" or to == "channel" then
	...
	if matches[1]:lower() == 'help' and msg.to.type == 'user' or matches[1]:lower() == 'pmhelp' and is_admin1(msg) and msg.to.type ~= 'user' then
		...
		text = "Welcome to Soft_TG\n\nTo get a list of Tg groups use /chats or /chatlist for a document list of chats.\n\n  new Soft_TG group, contact a support group:\n\nFor  !support\n\nFor more information, check out our Bot ID :\n\n@Soft_TG\n\nThanks for using @Soft_TG"
     	return text
    end
	...
	elseif matches[1]:lower() == 'chats' and to == 'user' then
